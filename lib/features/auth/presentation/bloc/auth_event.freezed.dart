...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthCheckStatus value)?  checkStatus,TResult Function( AuthLoginSubmitted value)?  loginSubmitted,TResult Function( AuthLogoutRequested value)?  logoutRequested,TResult Function( AuthSessionExpired value)?  sessionExpired,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AuthCheckStatus() when checkStatus != null:
return checkStatus(_that);case AuthLoginSubmitted() when loginSubmitted != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthCheckStatus value)  checkStatus,required TResult Function( AuthLoginSubmitted value)  loginSubmitted,required TResult Function( AuthLogoutRequested value)  logoutRequested,required TResult Function( AuthSessionExpired value)  sessionExpired,}){
final _that = this;
switch (_that) {
case AuthCheckStatus():
return checkStatus(_that);case AuthLoginSubmitted():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthCheckStatus value)?  checkStatus,TResult? Function( AuthLoginSubmitted value)?  loginSubmitted,TResult? Function( AuthLogoutRequested value)?  logoutRequested,TResult? Function( AuthSessionExpired value)?  sessionExpired,}){
final _that = this;
switch (_that) {
case AuthCheckStatus() when checkStatus != null:
return checkStatus(_that);case AuthLoginSubmitted() when loginSubmitted != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkStatus,TResult Function( String email,  String password)?  loginSubmitted,TResult Function()?  logoutRequested,TResult Function()?  sessionExpired,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthCheckStatus() when checkStatus != null:
return checkStatus();case AuthLoginSubmitted() when loginSubmitted != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkStatus,required TResult Function( String email,  String password)  loginSubmitted,required TResult Function()  logoutRequested,required TResult Function()  sessionExpired,}) {final _that = this;
switch (_that) {
case AuthCheckStatus():
return checkStatus();case AuthLoginSubmitted():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkStatus,TResult? Function( String email,  String password)?  loginSubmitted,TResult? Function()?  logoutRequested,TResult? Function()?  sessionExpired,}) {final _that = this;
switch (_that) {
case AuthCheckStatus() when checkStatus != null:
return checkStatus();case AuthLoginSubmitted() when loginSubmitted != null:
return loginSubmitted(_that.email,_that.password);case AuthLogoutRequested() when logoutRequested != null:
